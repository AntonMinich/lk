...
type PartnerRegisterFormProps = {
  ...
  cancelTo: string;
  cancelLabel?: string;
  onSubmit: (payload: PartnerRegisterPayload) => Promise<{ ok: true } | { ok: false; message: string }>;
};
  ...
  return (
    <form className="register-form" onSubmit={handleSubmit} noValidate>
      <section className="register-section">
        ...
        <a className="register-download" href={AGREEMENT_HREF} download="dogovor-o-sotrudnichestve.html">
      ...
      <div className="register-actions">
        <Link to={cancelTo} className="secondary-btn">
          {cancelLabel}
        </Link>
